...
* tipycoin.conf: contains configuration settings for tipycoind or tipycoin-qt
* tipycoind.pid: stores the process id of tipycoind while running
...
* debug.log: contains debug information and general logging generated by tipycoind or tipycoin-qt
