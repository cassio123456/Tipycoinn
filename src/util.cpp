...
const char * const BITCOIN_CONF_FILENAME = "tipycoin.conf";
const char * const BITCOIN_PID_FILENAME = "tipycoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Tipycoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Tipycoin";
#else
    // Unix
    return pathRet / ".tipycoin";
#endif
#endif
}
