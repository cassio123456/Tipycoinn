...
{
    const char* pszTimestamp = "So1111me newspaper headline that describes something that happened today";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0f1dab3ff8005a5b44a593798681df81dea9cae108305e58bb289da480c41c0b");
        ...
        consensus.defaultAssumeValid = uint256S("0x0f1dab3ff8005a5b44a593798681df81dea9cae108305e58bb289da480c41c0b"); //1441280
        ...
        genesis = CreateGenesisBlock(1660994723, 252610, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0f1dab3ff8005a5b44a593798681df81dea9cae108305e58bb289da480c41c0b"));
        assert(genesis.hashMerkleRoot == uint256S("0x1823d16205151e118af58f04c3870bf26135f4d149501057d27b3195378872ee"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.tipycoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.tipycointools.com");
        //vSeeds.emplace_back("dnsseed.tipycoinpool.org");
        vSeeds.emplace_back("tipycoin.ga");
        ...
        checkpointData = {
            {
                {  0, uint256S("0x0f1dab3ff8005a5b44a593798681df81dea9cae108305e58bb289da480c41c0b")},
            }
        };

        chainTxData = ChainTxData{
            // Data as of block 59c9b9d3fec105bdc716d84caa7579503d5b05b73618d0bf2d5fa639f780a011 (height 1353397).
            1660994723, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x50c3c18d00bc0bbe1b316d362edd7bf6d072087e36c6bba110ab76d7cb0a7834"); //612653
        ...
        genesis = CreateGenesisBlock(1486949366, 632943, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x50c3c18d00bc0bbe1b316d362edd7bf6d072087e36c6bba110ab76d7cb0a7834"));
        assert(genesis.hashMerkleRoot == uint256S("0x1823d16205151e118af58f04c3870bf26135f4d149501057d27b3195378872ee"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.tipycointools.com");
        //vSeeds.emplace_back("seed-b.tipycoin.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1798d400a5b327979bcfe6388cfa97481e8662d70f4943e1cff010a536936175"));
        assert(genesis.hashMerkleRoot == uint256S("0x1823d16205151e118af58f04c3870bf26135f4d149501057d27b3195378872ee"));
