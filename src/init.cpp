...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/tipycoin-project/tipycoin>";
    const std::string URL_WEBSITE = "<https://tipycoin.org>";
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if tipycoin is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if tipycoin is started while in a temporary directory.\n",
