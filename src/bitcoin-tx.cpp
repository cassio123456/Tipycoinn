...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s tipycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tipycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tipycoin transaction") + "\n" +
              "  tipycoin-tx [options] -create [commands]   " + _("Create hex-encoded tipycoin transaction") + "\n" +
              "\n";
